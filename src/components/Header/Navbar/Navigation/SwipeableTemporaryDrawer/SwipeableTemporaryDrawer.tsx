    ...
    const list = (anchor: Anchor) => (
        ...
        >
            ...
            <List>
                ...
                <ListItem key={'Приёмная'} disablePadding>
                    <NavLink to={'/public-reception'} className={setActive}>
                        <ListItemButton>
                            <ListItemIcon>
                                <ReceiptLongIcon className={classes.icon} />
                            </ListItemIcon>
                            <ListItemText primary={'Приёмная'} />
                        </ListItemButton>
                    </NavLink>
                </ListItem>
                <ListItem key={'Онлайн-приёмная'} disablePadding>
                    <NavLink to={'/online-reception'} className={setActive}>
                        <ListItemButton>
                            <ListItemIcon>
                                <LanguageIcon className={classes.icon} />
                            </ListItemIcon>
                            <ListItemText primary={'Онлайн-приёмная'} />
                        </ListItemButton>
                    </NavLink>
                </ListItem>
            </List>
