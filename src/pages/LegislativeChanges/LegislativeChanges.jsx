...
const LegislativeChanges = () => (
    <PageTitle title={'Изменения в законодательстве о занятости населения (с 01.01.2019г.)'}>
        <article className={classes.article}>
            ...
            <p><Link className={classes.upper} to={'http://www.consultant.ru/document/cons_doc_LAW_308156/'} target={'_blank'}>Федеральный закон</Link> от 03.10.2018 г. № 350-ФЗ "О внесении изменений в отдельные законодательные акты Российской Федерации по вопросам назначения и выплаты пенсий".</p>
